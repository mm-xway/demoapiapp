...
module.exports = {
	...
	// API key
	apikey: 'pgb4sPO+tghB4QsLo5ACJvISvmNky30v',
	...
	http: {
		...
		port: 9081 || parseInt(process.env.PORT),
	...
	session: {
		...
		encryptionKey: 'X/gqgQrJNAK5vCniLiLagoL45QDqcBuhCOzTmguLFlw=',
		signatureAlgorithm: 'sha512-drop256',
		signatureKey: 'LQTj7m3Em+epGTg2rGcFd+Sk71J0tSXJvshPl38dq6+n47qYvBgopTH1WTbIqBPaKwCvPtINWldBGsn0gXb8cw==',
		// should be a large unguessable string
		secret: 'RXRMAU+ukc0+Nt5TimZMjMOJDmBENCTM',
	...
	cookieSecret: 'SMUB9smclRJM6LwwOsI17nhILUXBW43M',
